...
enum EDischargeDisposition{
    HOME = "home",
    ALTERNATIVE_HOME = "alt-home",
    OTHER_HEALTHCARE_FACILITY = "other-hcf",
    HOSPICE = "hosp",
    LONG_TERM_CARE = "long",
    LEFT_AGAINST_ADVICE = "aadvice",
    EXPIRED = "exp",
    PSYCHIC_HOSPITAL = "psy",
    REHABILITATION = "rehab",
    SKILLED_NURSING_FACILITY = "snf",
    OTHER = "oth"
}

type TDischargeDisposition = `${EDischargeDisposition}`;

export { EDischargeDisposition };
export type { TDischargeDisposition }